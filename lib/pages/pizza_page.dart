        ...
        children: [
          Stack(children: [
            ...
            Container(
              ...
              child: const Text(
                "Pizza Hut tantalizes the senses with its irresistible combination of perfectly baked crust, bubbling cheese, and flavorful toppings, offering a culinary experience that's simply unforgettable..",
                style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w500,
                    color: Colors.black54),
            ...
            Row(
              ...
              children: [
                Container(
                  margin: const EdgeInsets.only(left: 200, top: 611),
                  child: const Text(
                    "See more.",
                    style: TextStyle(
                      fontSize: 12,
